...
public class MiscOptionsWindow extends JFrame {
    ...
    public MiscOptionsWindow (GestorBD db, Administrador admin, AdministradorWindow w) throws NullPointerException {
        ...
        this.add (((Supplier <JPanel>) ( () -> {
            ...
            pp.add (((Supplier <JPanel>) ( () -> {
                ...
                p.add (((Supplier <JPanel>) ( () -> {
                    ...
                    JTextField t[] = new JTextField [] {
                            ...
                            new JTextField (Settings.getAdminKey (), 30)
                    };
                                    ...
                                    try {
                                        ...
                                        b [6].setEnabled (!(t [0].getText ()
                                                ...
                                                && new BigDecimal (String.format ("%.2f",
                                                        ((SpinnerNumberModel) sp.getModel ()).getNumber ()
                                                                .doubleValue ())
                                                        .replace (",", "."))
                                                                .setScale (2, RoundingMode.HALF_EVEN)
                                                                .equals (new BigDecimal (
                                                                        Settings.defaults ()
                                                                                .getProperty ("precioentrada"))
                                                                                        .setScale (2,
                                                ...
                                                && t [2].getText ()
                                                        .equals (Settings.defaults ().getProperty ("adminkey"))));
                                    }
                    ...
                    q.add (((Supplier <JPanel>) ( () -> {
                        ...
                        r.add (((Supplier <JSpinner>) ( () -> {
                            ...
                            ((SpinnerNumberModel) sp.getModel ())
                                    .setValue (Settings.getPrecioEntrada ().doubleValue ());
                    ...
                    q.add (((Supplier <JPanel>) ( () -> {
                        ...
                        r.add (((Supplier <JLabel>) ( () -> {
                            JLabel l = new JLabel ("Visualización de los asientos:");
                            l.setFont (l.getFont ().deriveFont (Font.BOLD, 14f));
                    ...
                    q.add (((Supplier <JPanel>) ( () -> {
                        ...
                        r.add (((Supplier <JLabel>) ( () -> {
                            JLabel l = new JLabel ("Llave inicial de registro de administrador:");
                            l.setFont (l.getFont ().deriveFont (Font.BOLD, 14f));
                        ...
                        r.add (((Supplier <JTextField>) ( () -> {
                            t [2].getDocument ().addDocumentListener (new DocumentListener () {
                                @Override
                                public void insertUpdate (DocumentEvent e) {
                                    this.changedUpdate (e);
                                }
                                ...
                                public void changedUpdate (DocumentEvent e) {
                                    try {
                                        b [4].setEnabled (Utils.isValidAdminKey (t [2].getText ())
                                                && !t [2].getText ().equals (Settings.getAdminKey ()));
                        ...
                        r.add (((Supplier <JButton>) ( () -> {
                            ...
                            b [4].addActionListener (e -> {
                                Settings.setAdminKey (t [2].getText ());
                                Settings.save ();
                    ...
                    q.add (((Supplier <JButton>) ( () -> {
                        ...
                        b [6].addActionListener (e -> {
                            ...
                            t [2].setText (Settings.getAdminKey ());
                ...
                p.add (((Supplier <JPanel>) ( () -> {
                    ...
                    q.add (((Supplier <JPanel>) ( () -> {
                        ...
                        JSpinner sp = new JSpinner (
                                new SpinnerNumberModel (Settings.getDescuentoEspectador (), 0, 99, 1));

                        JButton b[] = new JButton [] {
                                new JButton (new ImageIcon (
                                        MiscOptionsWindow.class
                        ...
                        r.add (((Supplier <JButton>) ( () -> {
                            ...
                            b [2].addActionListener (e -> {
                                cb.setSelectedIndex (
                                        Integer.parseInt (Settings.defaults ().getProperty ("diaespectador")));
                                ((SpinnerNumberModel) sp.getModel ())
                                        .setValue (Integer
                                                .parseInt (Settings.defaults ().getProperty ("descuentoespectador")));
                ...
                p.add (((Supplier <JPanel>) ( () -> {
                        ...
                        r.add (((Supplier <JScrollPane>) ( () -> {
                            ...
                            t.getSelectionModel ()
                                    .addListSelectionListener (e -> b [1].setEnabled ((((BooleanSupplier) ( () -> {
                                        ...
                                        return !(i == -1
                                                || ((ComplementosTableModel) t.getModel ()).get (i).isDefault ());
                                    })).getAsBoolean ())));
                        ...
                        r.add (((Supplier <JPanel>) ( () -> {
                            ...
                            s.add (((Supplier <JButton>) ( () -> {
                                b [0].addActionListener (e -> {
                                    ...
                                    fields [1].setToolTipText (
                                            String.format ("Precio (en euros, dejar vacío para %.2f €)",
                    ...
                    q.add (((Supplier <JButton>) ( () -> {
                        JButton b = new JButton ("Eliminar todos los complementos.");
                        ...
                        b.addActionListener (e -> {
                            ...
                            db.delete (((Supplier <List <Complemento>>) ( () -> {
                                List <Complemento> l = db.getComplementos ();
            ...
            pp.add (Box.createRigidArea (new Dimension (0, 25)));

            pp.add (((Supplier <JButton>) ( () -> {
                JButton b = new JButton ("Borrar todos los datos");
